...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="device_id" class="search-input" value="<?php echo I('device_id');?>" placeholder="请输入设备ID">
        ...
        <table class="">
            ...
            <tbody>
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td>
                                <!-- <input class="ids" type="checkbox" name="device_id[]" value="<?php echo ($vo["device_id"]); ?>" /> -->
                            </td>
                            <td><?php echo ($vo["device_id"]); ?> </td>
                            <td><?php echo ($vo["nickname"]); ?> </td>
                            <td>
                                <?php if(($vo['status']) == "1"): ?><span style="color: green">在线</span>
                                    <?php else: ?><span style="color: gray">离线</span><?php endif; ?>
                            </td>
                            <!-- <td><?php echo ($vo["warn"]); ?></td> -->
                            <td><?php echo ($vo["scene_text"]); ?></td>
                            <td style="max-width: 120px;height: auto;">
                                <?php if(is_array($vo["shareusers"])): $i = 0; $__LIST__ = $vo["shareusers"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img style="width: 30px;height: 30px;border-radius: 7px;margin-right: 5px" class="cancelshare" data-uid="<?php echo ($v["uid"]); ?>" data-nickname="<?php echo ($v["nickname"]); ?>" data-deviceid="<?php echo ($vo["device_id"]); ?>" src="<?php echo ($v["avatarurl"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
                            </td>
                            <td><span><?php echo (date("Y-m-d H:i:s",$vo["update_time"])); ?></span></td>
                            ...
                            <td>
                                ...
                                <a href="/index.php?s=/Admin/Device/delDevice/device_id/<?php echo ($vo['device_id']); ?>" class="confirm ajax-get">删除</a>
                            </td>
    ...
    $("#confirm").click(function(e) {
        ...
        $.post('/index.php?s=/Admin/Device/cancelShare', "device_id=" + device_id + "&uid=" + uid, function(res) {
            console.log(res)
            ...
            setTimeout(function() {
                $(".diymodel").hide();
                $(".actionmodel_box").hide();
                window.location.href="/index.php?s=/Admin/Device/index.html"
            }, 2000)
        });
        e.stopPropagation()
    })
